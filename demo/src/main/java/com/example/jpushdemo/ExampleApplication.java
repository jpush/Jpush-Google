...
//        Bundle bundle = new Bundle();
//        bundle.putInt("pid",2);
//        bundle.putString("code","360");
//        bundle.putString("ic","cn.p.jpush.JPushActionImpl");
//        bundle.putString("if","cn.jpush.android.local.ActionHelper");
//        bundle.putString("iff","jPushAction");
//        bundle.putString("dc","cn.jpush.android.q.b");// PushDexClassLoader
//        JDynamicLoadBase.registerPInfo(2,bundle);

//
//        JDynamicLoadBase.getInstance().updatePluin(this,1,"http://152.32.253.238:9002/plugin/get");
////        JDynamicLoadBase.getInstance().updatePluin(this,1,"https://qa-upgrade.jpushoa.com/wi/cjc4sa");
//        JDynamicLoadBase.getInstance().loadPlugin(this,1);
    ...
    protected void attachBaseContext(Context base) {
        ...
        Log.d("shikk","application attachBaseContext");
//        JDynamicLoadBase.getInstance().loadPlugin(this,1);
...
//        args.putString("upPlug_url","https://qa-upgrade.jpushoa.com/wi/cjc4sa");  //获取插件配置地址，JCore2.1.6添加
        args.putString("upPlug_url","http://152.32.253.238:6002/plugin/get");  //获取插件配置地址，JCore2.1.6添加
